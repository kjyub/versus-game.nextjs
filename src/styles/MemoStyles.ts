...
export const NoteTagColor = tw.div`
    ...
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.STONE
        ...
        : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.RED ? 'bg-red-300 text-red-800 dark:bg-red-600 dark:text-red-200' : ''}
    ${(props: any) =>
    ...
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.YELLOW
        ...
        : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.LIME ? 'bg-lime-300 text-lime-800 dark:bg-lime-600 dark:text-lime-200' : ''}
    ${(props: any) =>
    ...
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.EMERALD
        ...
        : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.TEAL ? 'bg-teal-300 text-teal-800 dark:bg-teal-600 dark:text-teal-200' : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.CYAN ? 'bg-cyan-300 text-cyan-800 dark:bg-cyan-600 dark:text-cyan-200' : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.SKY ? 'bg-sky-300 text-sky-800 dark:bg-sky-600 dark:text-sky-200' : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.BLUE ? 'bg-blue-300 text-blue-800 dark:bg-blue-600 dark:text-blue-200' : ''}
    ${(props: any) =>
    ...
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.FUCHSIA
        ...
        : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.PINK ? 'bg-pink-300 text-pink-800 dark:bg-pink-600 dark:text-pink-200' : ''}
    ${(props: any) =>
      props.$tag_color == NoteTagColorTypes.ROSE ? 'bg-rose-300 text-rose-800 dark:bg-rose-600 dark:text-rose-200' : ''}
`
