...
export default function VersusEditor({ isUpdate = false, gameData = null, saveOnClose = null }: IVersusEditor) {
  ...
  const [thumbnailType, setThumbnailType] = useState<ThumbnailImageTypes>(ThumbnailImageTypes.IMAGE)
        ...
        <VS.EditInfoBox>
          ...
          <VS.InputContainer>
            ...
            <VS.InputTypeButtonList>
              <VS.InputTypeButton
                $is_show={thumbnailType === ThumbnailImageTypes.IMAGE}
                onClick={() => {
              ...
              <VS.InputTypeButton
                $is_show={thumbnailType === ThumbnailImageTypes.TEXT}
                onClick={() => {
            ...
            <div className="relative w-full max-lg:h-56 max-2xl:h-72 2xl:h-56">
              <VersusThumbnailImageEdit
                isShow={thumbnailType === ThumbnailImageTypes.IMAGE}
