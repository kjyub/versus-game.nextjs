...
export default function VersusEmbedModal({ game, close }: IVersusEmbedModal) {
    ...
    useEffect(() => {
        setSource(`<iframe src="https://chooseming.com/embed/${game.nanoId}" width="100%" height="400px" frameborder="0"></iframe>`)
    }, [game])
        ...
        <VS.ShareEmbedModalLayout className="max-sm:w-[80vw] sm:w-[560px]">
            ...
            <div className="flex flex-col w-full space-y-2">
                <div className="relative flex justify-between w-full overflow-hidden">
                    ...
                    <VS.ShareEmbedModalMessage $is_show={showMessage}>
                        {message}
                    </VS.ShareEmbedModalMessage>
                </div>
                <textarea
