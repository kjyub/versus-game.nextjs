        ...
        <VS.PrivacyModalLayout>
            ...
            <div className="flex flex-col mt-4 space-y-2">
                <VS.PrivacyModalItem
                    ...
                    onClick={()=>{handlePrivacyType(PrivacyTypes.PUBLIC)}}
                >
                    {PrivacyTypeIcons[PrivacyTypes.PUBLIC]}
                    <div className="info">
                        <span className="title">
                            {PrivacyTypeNames[PrivacyTypes.PUBLIC]}
                        </span>
                        <p className="content">
                            누구나 볼 수 있습니다.
                        </p>
                ...
                <VS.PrivacyModalItem
                    ...
                    onClick={()=>{handlePrivacyType(PrivacyTypes.RESTRICTED)}}
                >
                    {PrivacyTypeIcons[PrivacyTypes.RESTRICTED]}
                    <div className="info">
                        <span className="title">
                            {PrivacyTypeNames[PrivacyTypes.RESTRICTED]}
                        </span>
                        <p className="content">
                            링크를 가지고 있으면 볼 수 있습니다.
                        </p>
                    </div>
                </VS.PrivacyModalItem>
                <VS.PrivacyModalItem
                    $is_active={privacyType === PrivacyTypes.PRIVATE}
                    onClick={()=>{handlePrivacyType(PrivacyTypes.PRIVATE)}}
                >
                    {PrivacyTypeIcons[PrivacyTypes.PRIVATE]}
                    <div className="info">
                        <span className="title">
                            {PrivacyTypeNames[PrivacyTypes.PRIVATE]}
                        </span>
                        <p className="content">
                            작성자만 볼 수 있습니다.
                        </p>
