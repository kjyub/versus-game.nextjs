...
export default class VersusGame extends AbsApiObject {
  ...
  parseResponse(json: object) {
    ...
    if (json.thumbnailImageId) this._thumbnailImageId = json.thumbnailImageId
    if (json.thumbnailImageUrl) this._thumbnailImageUrl = json.thumbnailImageUrl
    if (json.thumbnailImageType) this._thumbnailImageType = json.thumbnailImageType
