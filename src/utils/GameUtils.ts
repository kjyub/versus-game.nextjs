...
export default class GameUtils {
    ...
    // 연관 게임 가져오기
    static async getRelatedGames(relatedGameIds: Array<string> = [], userId: string = "", gameCount: number = GameConsts.RELATED_GAME_COUNT) {
        const relatedGameObjectIds: Array<mongoose.Types.ObjectId> = relatedGameIds.map(gameId => (
    ...
    // 연관 랜덤 게임 가져오기
    static async getRelatedRandomGames(excludeGameIds: Array<string> = [], userId: string = "", gameCount: number = GameConsts.RELATED_GAME_COUNT) {
